"""Temporary CI-only V-013A final validation helper; removed after evidence capture."""
...
_ROOT = Path.cwd()
_RESULT_DIR = _ROOT / "artifacts" / "v013a-final-validation"
...
def _validate() -> None:
    ...
    if summary["focused"] != {"total": 39, "passed": 39, "failures": 0, "errors": 0, "skipped": 0}:
